...
![Desktop View](https://xnuevecyber.com/ftp/github/gobuster.jpg)
...
![Desktop View](https://xnuevecyber.com/ftp/github/anwser.jpg){: width="1200" height="630" }

##  Task 3 Getting a shell
Find a form to upload and get a reverse shell, and find the flag.
Let's go to the target machine `10.10.1.104` Mine is this one, the Browser displays this
![Desktop View](https://xnuevecyber.com/ftp/github/target.jpg){: width="1200" height="630" }
>
...
![Desktop View](https://xnuevecyber.com/ftp/github/php.jpg){: width="1200" height="630" }
>
...
![Desktop View](https://xnuevecyber.com/ftp/github/not.jpg){: width="1200" heigth="630" }
...
![Desktop View](https://xnuevecyber.com/ftp/github/php.png){: width="980" heigth="630" }
After that we have to add a 5 at the end `shell.php5`
Have to be like this
![Desktop View](https://xnuevecyber.com/ftp/github/php5.png){: width="980" heigth="630" }
...
![Desktop View](https://xnuevecyber.com/ftp/github/yes.jpg){: width="980" heigth="630" }

`Now Let's Configure a Listener to get the reverse shell`
```bash
nc -nlvp 4444
```
![Desktop View](https://xnuevecyber.com/ftp/github/nc.jpg)
> `nc` calls netcat
...
{: .prompt-info }
 ...
 ![Desktop View](https://xnuevecyber.com/ftp/github/shell.jpg)
...
```
 ...
 ```
 ![Desktop View](https://xnuevecyber.com/ftp/github/task3.jpg)
...
```
{: .prompt-tip }
![Desktop View](https://xnuevecyber.com/ftp/github/root.jpg)
