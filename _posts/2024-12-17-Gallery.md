...
tags: [CTF]
image:
  path: http://xnuevecyber.com/ftp/github/gallery/port.png
---

## Introduction
First lets start the machine.
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/start.jpg){: width="1200" height="630" }
`Let's answer the questions`

## How Many Ports Are open?
Firt's Lets can the IP `10.10.27.38`
nmap -sCV `10.10.27.38`
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/scan.jpg){: width="1200" height="630" }
There are two ports open, `80, 8080` Let's navigate to `http://10.10.27.38:8080`
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/cms.jpg)
So I think that is vulnerable to sql injection so i tried to log with `'OR 1=1-- -` user:pass
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/sql.jpg){: width="1200" height="630" }
It works, now let's go to <https://www.exploit-db.com/> then in search filter type `Simple Image Gallery`
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/vuln.png){: width="1200" height="630" }
So in that `db` says that is vulnerable to sql injection, let's read that exploit. the exploit says this.
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/sqlex.jpg){: width="1200" height="630" }
`let's do the same as the exploit`
Go to Albums
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/album.jpg){: width="1200" height="630" }
...
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/pulsa.jpg){: width="1200" height="630" }
`Once you got burp suite on` click on whatever image, i click on test.jpg
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/int.jpg){: width="1200" height="630" }
...
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/sqls.jpg){: width="1200" height="630" }
...
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/tables.jpg){: width="1200" height="630" }
...
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/hash.jpg)
...
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/sub.jpg){: width="1200" height="630" }
...
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/lst.jpg)
`We got the shell`
As you can see i tried to read de `user.txt` but i dont got permissions
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/data.jpg)
...
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/linp.jpg){: width="1200" height="630" }
>
...
Then run `./linpeas.sh`
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/exe.jpg)
After run the script, we found this.
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/psw.jpg){: width="1200" height="630" }
...
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/bash.jpg)
...
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/flag.jpg){  :width="1200" height="630" }
...
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/sudo.jpg){:width="1200" height="630" }
...
Here we go
![Desktop View](http://xnuevecyber.com/ftp/github/gallery/root.jpg)
